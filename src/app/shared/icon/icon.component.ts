...
/** Inline SVG paths, so no icon font or network request is needed. */
...
export class IconComponent {
  ...
  /** Paths come from the constant map above — never from user
   *  input — so bypassing sanitisation here is safe. */
